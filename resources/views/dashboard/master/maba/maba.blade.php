...
@section('content')
  ...
  <div class="page-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">PMB</li>
              <li class="breadcrumb-item active">MABA</li>
            </ol>
          </div>
          <div class="col-sm-6">
            <!-- Bookmark Start-->
    ...
    <div>
        <p>silahakan lakukan export untuk membuat anda lebih mudah dalam melakukan import data mahasiswa, namun perlu penambahan NIM untuk mahasiswa</p>
      </div>
  </div>

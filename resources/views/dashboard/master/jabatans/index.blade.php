    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('jabatans.add') }}" class="btn btn-primary">Add Jabatan</a>
        </div>
        <div class="col-sm-10 container-fluid ">
          {{-- <form method="GET" action="{{ route('jabatans') }}" class="d-flex justify-content-center">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form method="POST" action="{{ route('jabatans.delete', [$a]) }}">
                      @csrf
                      <a href="{{ route('jabatans.edit', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit"

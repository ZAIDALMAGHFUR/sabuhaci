    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('jurnal.add') }}" class="btn btn-primary">Add Jurnal</a>
        </div>
        <div class="col-sm-10 container-fluid ">
          {{-- <form method="GET" action="{{ route('jurnal') }}" class="d-flex justify-content-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form method="POST" action="{{ route('jurnal.delete', [$a]) }}">
                      @csrf
                      <a href="{{ route('jurnal.edit', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit"
                        data-bs-id=""><i class="fa fa-edit"></i></a>

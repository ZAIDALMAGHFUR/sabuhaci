    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('page.add') }}" class="btn btn-primary">Add Halaman</a>
        </div>
        <div class="col-sm-10 container-fluid ">
          {{-- <form method="GET" action="{{ route('page') }}" class="d-flex justify-content-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form method="POST" action="{{ route('page.delete', [$a]) }}">
                      @csrf
                      <a href="{{ route('page.edit', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit"

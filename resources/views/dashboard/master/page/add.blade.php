      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambahkan Halaman</li>
          </ol>
        </div>
        <div class="col-sm-6">
          <!-- Bookmark Start-->
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('page.save') }}"
                  ...
                  <div class="row" style="row-gap: 20px;">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="menu" value="{{ old('menu') }}" id="menu" required>
                    </div>
                    <div class="col-md-6">
                      <label for="group_menu" class="form-label">Grup Menu Halaman</label>
                      <input type="text" class="form-control" name="group_menu" value="{{ old('group_menu') }}"
                        id="group_menu">

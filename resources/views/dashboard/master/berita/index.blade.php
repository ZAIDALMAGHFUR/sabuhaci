    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('berita.add') }}" class="btn btn-primary">Add Berita</a>
        </div>
        <div class="col-sm-10 container-fluid ">
          {{-- <form method="GET" action="{{ route('berita') }}" class="d-flex justify-content-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form method="POST" action="{{ route('berita.delete', [$a]) }}">
                      @csrf
                      <a href="{{ route('berita.edit', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit"

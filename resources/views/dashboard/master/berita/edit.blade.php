            ...
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="POST" class="needs-validation" novalidate=""
                  action="{{ route('berita.update', [$data]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('POST')
                  @if ($errors->any())
                  ...
                  <div class="row" style="row-gap: 20px;">
                    ...
                    <div class="col-md-6">
                      <label for="category" class="form-label">Category Berita</label>
                      <input type="text" class="form-control" name="category"
                        value="{{ old('category', $data->category) }}" id="category" required>
                    </div>
                    <div class="col-md-6">
                      <label for="tags" class="form-label">Tags Berita</label>
                      <input type="text" class="form-control" name="tags"
                        value="{{ old('tags', join(',', $data->tags)) }}" id="tags" required>
                    ...
                    <div class="col-md-6">
                      <label for="description" class="form-label">Description Berita</label>

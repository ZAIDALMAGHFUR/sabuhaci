    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('galeri.add') }}" class="btn btn-primary">Add Galeri</a>
        </div>
        <div class="col-sm-10 container-fluid ">
          {{-- <form method="GET" action="{{ route('galeri') }}" class="d-flex justify-content-center">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form method="POST" action="{{ route('galeri.delete', [$a]) }}">
                      @csrf
                      <a href="{{ route('galeri.edit', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit"

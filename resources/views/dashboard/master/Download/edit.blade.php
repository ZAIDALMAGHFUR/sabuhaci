      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                  <form method="post" class="needs-validation" novalidate="" action="{{ route('update.download', [$data]) }}" enctype="multipart/form-data">
                  @csrf
                  @if ($errors->any())
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control" name="file_path" value="{{ old('file_path', $data->file_path) }}" id="file_path" required>
                    </div>
                </div>
                <div class="col-md-6">

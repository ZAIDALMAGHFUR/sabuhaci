...
<div class="page-body">
  <div class="container-fluid">
    <div class="page-header">
      <div class="row">
        <div class="col-sm-6">
          <h3>Tambahkan Galeri Item</h3>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Applications</a></li>
            <li class="breadcrumb-item">Data Pengguna</li>
            <li class="breadcrumb-item active">Tambahkan Galeri Item</li>
          </ol>
        </div>
        <div class="col-sm-6">
          <!-- Bookmark Start-->
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('gallery-items.save') }}"
                    ...
                    <div class="col-md-8">
                      <div class="mb-3">
                        ...
                        <select class="js-example-basic-single col-sm-12" name="gallery_id" id="gallery_id">
                          ...
                          <option @selected($gallery->id == old("gallery_id")) value="{{ $gallery->id }}">{{

...
<div class="page-body">
  <div class="container-fluid">
    <div class="page-header">
      <div class="row">
        <div class="col-sm-6">
          <h3>Tambahkan Rentang Nilai</h3>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Applications</a></li>
            <li class="breadcrumb-item">Data Akademik</li>
            <li class="breadcrumb-item active">Tambahkan Rentang Nilai</li>
          </ol>
        </div>
        <div class="col-sm-6">
          <!-- Bookmark Start-->
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('rentang.save') }}" enctype="multipart/form-data">
                  @csrf 
                    @method('POST')
                  @if ($errors->any())
                  ...
                  <div class="row g-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="huruf_nilai" value="{{ old('huruf_nilai') }}" id="huruf_nilai" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                        <label for="bobot_nilai" class="form-label">Bobot Nilai</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="bobot_nilai" value="{{ old('bobot_nilai') }}" id="bobot_nilai" required>
                      </div>
                    </div>
                  </div>
                  <div class="row g-2 mt-3">

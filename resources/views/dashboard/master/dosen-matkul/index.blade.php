      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('dsnmatkul.add') }}" class="btn btn-primary add" type="button">Add
              Dosen Mata Kuliah</a>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  @foreach ($dsn as $a)
                    <tr style="text-align: center">
                      ...
                      <td>{{ $a->programStudies->name }}</td>
                      <td>{{ $a->tahunAcademic->tahun_akademik }}</td>
                      <td style="text-align: center">

                        <a href="{{ route('dsnmatkul.edit', [$a->id]) }}">
                          <button class="btn btn-primary btn-sm edit" type="button"><i class="fa fa-edit"></i></button>
                        </a>

                        <form method="POST" action="{{ route('dsnmatkul.delete', [$a->id]) }}" class="d-inline">
                          @csrf
                          @method('DELETE')

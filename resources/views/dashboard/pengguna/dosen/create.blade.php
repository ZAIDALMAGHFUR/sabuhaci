      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambahkan Dosen</li>
          </ol>
        </div>
        <div class="col-sm-6">
          <!-- Bookmark Start-->
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('dosen-admin/save') }}" enctype="multipart/form-data">
                  @csrf 
                    @method('POST')
                  @if ($errors->any())
                  ...
                  <div class="row g-2 mt-4">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_dosen" value="{{ old('nama_dosen') }}" id="nama_dosen" required>
                        </div>
                    </div>
                    <div class="col-md-6">

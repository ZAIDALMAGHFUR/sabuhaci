      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <div class="col-lg-12">
              <div class="card p-3">
                <form method="post" class="needs-validation" novalidate="" action="{{ route('mahasiswa.admin.update', [$data]) }}" enctype="multipart/form-data">
                  @csrf 
                    @method('POST')
                  @if ($errors->any())
                  ...
                  @endif
                    <div class="row g-2 mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nim" value="{{ old('nim', $data->nim) }}" id="nim" required>
                            </div>
                        </div>
                    </div>
                    <div class="row g-2 mt-3">
                    ...
                    <div class="row g-2 mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" name="foto" value="{{ old('foto', $data->foto) }}" id="foto" required>
                            </div>
                        </div>
                    </div>

      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="col-sm-10 container-fluid">
            <form action="{{ route('compensation.edit', $mahasiswa->id) }}" method="GET">
                ...
                <tbody>
                  @foreach ($nilaiqu as $a)
                    <tr style="text-align: center">
                      ...
                      <td>
                        <form method="POST" action="{{ route('compensation.delete', [$a]) }}">
                          @csrf
                          <a href="{{ route('compensation.replacement', [$a->id]) }}" type="button" class="btn btn-primary btn-xs edit" data-bs-id=""><i
